    ...
    <section className="about">
      ...
      <div className="center-content">
        <div className="team__desc">
          ...
          rerum, earum voluptas dolore temporibus quae animi ut, asperiores
          blanditiis illum eos eum impedit quod autem laudantium! Accusantium
          dolores ex repellendus. Quasi ad ullam necessitatibus dignissimos
          numquam eius aliquid obcaecati, laborum reprehenderit maiores, id odio
          voluptas a nobis, iure eum eveniet.
        </div>
            ...
            <div className="profile">
              ...
              <div className="profile__info">
                ...
                <div className="profile__links">
                  <a
                    href="https://github.com/ClintonAloo"
                    className="profile__link"
                  >
                    <AiFillGithub />
                  </a>
                  <a
                    href="https://www.linkedin.com/in/clinton-aloo-732a22184/"
                    className="profile__link"
                  >
                    <AiFillLinkedin />
                  </a>
                  <a
                    href="https://twitter.com/clintonaloo"
                    className="profile__link"
                  >
                    <AiFillTwitterCircle />
                  </a>
